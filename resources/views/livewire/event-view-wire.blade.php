<div>
    <div class="2xl:px-96 pt-10">
        ...
        <div class="grid grid-cols-5 gap-20">
            ...
            @endauth
            @guest
                <div class="col-span-2 py-5 h-fit sticky">
                    <div
                        class="bg-white/5 p-5 border border-white/5 rounded-xl flex flex-col gap-4 items-center text-white/50">
                        <h2>Please <span class="font-semibold">Sign in</span> to View Tickets</h2>
                        <a href="{{ route('login') }}" class="w-full">
                            <button class="btn btn-primary w-full h-12">Sign in / Register</button>
                        </a>
                    </div>
                </div>
            @endguest
