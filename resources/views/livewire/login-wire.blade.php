<div class="flex justify-center items-center bg-center bg-cover pt-20 pb-20">
    <div class="border border-white/10 bg-white/5 p-10 rounded-xl flex w-120 flex-col items-center justify-center">
        <div
        ...
        <p class="text-white/50 text-center">Sign in to explore and book the best events around you.</p>
        ...
        <a href="{{ route('auth.platform.redirect', ['platform' => 'google']) }}" class="w-full">
            <button class="btn btn-neutral h-12 w-full"><x-fab-google class="h-4 w-4" /> Sign in with
                Google</button>
        </a>
    </div>
</div>
