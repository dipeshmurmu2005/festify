        ...
        return $schema
            ->components([
                Section::make('Event Details')->schema([
                    ...
                    TextEntry::make('venue_capacity_override')
                        ->label('Venue Capacity'),
                    TextEntry::make('gross_ticket_revenue')
                ...
                Section::make('Event Bookings & Reservations')
                    ->schema([
                        TextEntry::make('reservations_count')
                            ->label('Total Reservations'),
                        TextEntry::make('active_ticket_bookings')
                            ->label('Total Bookings'),
                        TextEntry::make('available_general_admission_capacity')
                            ->label('Available General Admission Capacity'),
                    ])->columns(5)
                    ->columnSpanFull(),
                Section::make('Event Sessions')
                    ->schema([
                        RepeatableEntry::make('eventSessions')
                            ->schema([
